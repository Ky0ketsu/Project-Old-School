...
// PUBLIC METHODS --------------------------------------------------------------------------------------------------
    ...
    [SerializeField] bool debugLogInBuild = false;
    ...
    State nextState;
    public Camera gameCam,menuCam,stackCam;
    ...
    {
        UpdateCurrentState();
        UpdateStackCameraSettings();
    }

    void UpdateStackCameraSettings()
    {
        stackCam.orthographic = gameCam.orthographic;
        stackCam.orthographicSize = gameCam.orthographicSize;
        stackCam.fieldOfView = gameCam.fieldOfView;
        stackCam.transform.rotation = gameCam.transform.rotation;
    }


    void OnApplicationFocus(bool hasFocus)
    {
        if (hasFocus == false) Debug.Log("👁️ App <color=red>lost</color> FOCUS");
        else Debug.Log("👁️ App <color=green>gained</color> FOCUS");
    }
